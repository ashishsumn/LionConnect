...
public class MyPostRecyclerDataAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context context;

    private List<myPostDataStructure> partFeed;
    ...
    public MyPostRecyclerDataAdapter(List<myPostDataStructure> feed){
        partFeed = feed;
    }

    public void addDataToList(ArrayList<myPostDataStructure> data){
...
//        notifyItemRangeInserted( page, partFeed.size());
    ...
    public void addLoaderToList(){
        ...
        partFeed.add(new myPostDataStructure());
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_CARD) {
            ...
            return new MyPostRecyclerDataAdapter.CardViewHolder(view);
        }else if(viewType == VIEW_END){
            View view = inflater.inflate(R.layout.cardview_endfeed, parent, false);
            return new MyPostRecyclerDataAdapter.NoMoreFeedCard(view);
        }
        else {
            View view = inflater.inflate(R.layout.cardview_loading, parent, false);
            return new MyPostRecyclerDataAdapter.LoadingCardView(view);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if( viewHolder instanceof MyPostRecyclerDataAdapter.CardViewHolder){
            myPostDataStructure listItem = (myPostDataStructure) this.partFeed.get(position);
            final ImageView im = ((MyPostRecyclerDataAdapter.CardViewHolder)viewHolder).image;
            DisplayMetrics displayMetrics = new DisplayMetrics();
            ((Activity) context).getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);
            final int height = displayMetrics.heightPixels;
            final int width = displayMetrics.widthPixels;
            try{
                ((MyPostRecyclerDataAdapter.CardViewHolder)viewHolder).text.setText(listItem.getText());}
            catch (Exception e){
            ...
            ((MyPostRecyclerDataAdapter.CardViewHolder)viewHolder).user.setText(listItem.getUser());
            ((MyPostRecyclerDataAdapter.CardViewHolder)viewHolder).timeStamp.setText(listItem.getTimeStamp());
        }else if( viewHolder instanceof MyPostRecyclerDataAdapter.LoadingCardView){

        }else if(viewHolder instanceof MyPostRecyclerDataAdapter.NoMoreFeedCard){
