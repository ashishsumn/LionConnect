...
public class myPostDataStructure {
    ...
    public myPostDataStructure(Integer image, String txt, String user) {
        this.image_path = image;
        this.description = txt;
        this.user = user;
    }

    public myPostDataStructure(){

    }

    public myPostDataStructure(String photos, String description, String user, String userId,String timeStamp) {
